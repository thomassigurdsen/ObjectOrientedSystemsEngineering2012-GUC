...
\author{Martin Kristian Mellum 100874 \\ Thomas Sigurdsen 090320}
\date{\today}
...
Poking around will let you find the open-source community web page\cite{ezcomweb}. even though they use both mailing lists and IRC; their forums is the main communications channel.
...
\end{quotation}
OpenDungeons characterizes itself and its style of governing as a meritocracy. This means that whoever has the most work done in the project at any given time has the heaviest votes on any decision. Its developer group consists of a closely knit group counting somewhere between 5 and 15. Most of their communication is done through their forums.
\subsection{Boost}
